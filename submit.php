<?php
  ...
  if(Token == $_POST['token'])
  {
    ...
    array_push($referees,$_POST['referees1']);
    array_push($tel,$_POST['tel1']);
    ...
    if(isset($_POST['hobby4']) && !empty($_POST['hobby4']))
    {
      ...
      if(isset($_POST['referees2']) && !empty($_POST['referees2']))
    {
      if(isset($_POST['tel2']) && !empty($_POST['tel2']))
      {
        array_push($referees,$_POST['referees2']);
        array_push($tel,$_POST['tel2']);
      }
    }
    if(isset($_POST['referees3']) && !empty($_POST['referees3']))
    {
      if(isset($_POST['tel3']) && !empty($_POST['tel3']))
      {
        array_push($referees,$_POST['referees3']);
        array_push($tel,$_POST['tel3']);
      }
...
<div class="grid-container">
  ...
  <div class="zone-2">
    ...
    <div class="subTitle">
      <h4><?php echo ucwords($profession);?><h4>
    </div>
    <div class="group-1">
      <div class="title">
        <div class="box">
    ...
    <div class="group-3">
      ...
      <?php 
          for($i=0; $i<count($referees);$i++)
          {
            ...
            <li>
              <div class='msg-1'><br></div>
              <div class='msg-2'>" . ucwords($referees[$i]) ."</div>
              <div class='msg-3'>" . ucfirst($tel[$i]) . "</div>
            </li>
          </ul>";
          }
        ?>
