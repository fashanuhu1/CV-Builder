        ...
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="08089943505">
                </div>
                <div class="mb-3">
...
<div class="mb-3">
                    ...
                    <input type="maritalstatus" class="form-control" name="maritalstatus" required>
                    
                </div>
<div class="mb-3">
                    <label class="form-label">Origin</label>
                    <input type="origin" class="form-control" name="origin" required>
                    
                </div>
<div class="mb-3">
                    <label class="form-label">Local Government</label>
                    <input type="localgovernment" class="form-control" name="localgovernment" required>
                    
                </div>

<div class="mb-3">
                    <label class="form-label">Date of Birth</label>
                    <input type="dateofbirth" class="form-control" name="dateofbirth" required>
...
<div class="mb-3">
                    ...
                    <input type="religion" class="form-control" name="religion" required>
            ...
            <div class="border border-dark p-3 mb-3">    
                <h2>Referees (Max:3)</h2>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Referees</label>
                    <input type="text" name="referees1" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Tel</label>
                    <input type="text" name="tel1" class="form-control">
                </div>
                <div id="addReferees"></div>
                <div class="mb-3">
                    <button type="button" id="referees_hide" class="btn btn-primary form-control" onclick="addReferees()">+</button>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>About Me</h2>
